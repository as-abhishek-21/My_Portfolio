...
export const projects = [
  {
    ...
    tag: 'AI · Automation',
    description:
      'Autonomous agent that turns any event website into a lead list: Puppeteer scrapes the page, an LLM extracts exhibitor names from token-trimmed page text to keep API costs low, a search API enriches each company with website & LinkedIn, and live progress streams over Server-Sent Events into an auto-created Google Sheet.',
